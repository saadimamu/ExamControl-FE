                ...
                <div className="flex flex-col flex-no-grow items-center text-white p-16 text-center md:p-128 md:items-start md:flex-no-shrink md:flex-1 md:text-left">
                    ...
                    <FuseAnimate animation="transition.slideUpIn" delay={300}>
                        <Typography variant="h3" color="inherit" className="font-light">
                            اهلا بكم في نظام مجالس
                        </Typography>
                    </FuseAnimate>

                    <FuseAnimate delay={400}>
                        <Typography variant="subtitle1" color="inherit" className="max-w-512 mt-16">
                            نظام مجالس هو نظام يساعدك على ادارة جميع مجالس الجامعة
                        </Typography>
                    </FuseAnimate>
                </div>
                ...
                <FuseAnimate animation={{translateX: [0, '100%']}}>
                    ...
                    <Card className="w-full max-w-400 mx-auto m-16 md:m-0" square>
                        ...
                        <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128 ">
                            ...
                            <Typography variant="h6" className="text-center md:w-full mb-48">تسجيبل الدخول الى نظام مجالس</Typography>
